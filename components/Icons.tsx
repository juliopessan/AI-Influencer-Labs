...
export const BrainCircuitIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 13.5c1.194 1.194 2.388 2.388 3.582 3.582M9.5 13.5V9.75m0 3.75c-1.548-1.548-3.096-3.096-4.644-4.644m4.644 4.644L7.25 11.25m2.25 2.25L11.75 11.25m0 0l2.25-2.25m0 0l2.25-2.25M11.75 11.25l2.25 2.25m0 0l2.25 2.25m0 0l2.25 2.25M11.75 11.25V9m0 2.25V6.75m0 2.25h2.25m-2.25 0H9.5m2.25 0h-4.5m0 0H5m2.25 0v2.25m0-2.25V9.5m0 2.25v-4.5m0 0V5m2.25 0h2.25m-2.25 0H9.5m2.25-2.25h2.25m-2.25 0H9.5" />
...
export const ShareNetworkIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
